...
public class Test extends JFrame {
	...
	public Test() {
		...
		JLabel teamlabel1 = new JLabel("\u7B2C\u4E5D\u7D44");
		teamlabel1.setForeground(Color.WHITE);
		teamlabel1.setFont(new Font("微軟正黑體", Font.BOLD, 30));
		teamlabel1.setBounds(104, 36, 90, 60);
		sidebar.add(teamlabel1);
		
		JLabel teamlabel2 = new JLabel("\u5716\u66F8\u9928\u7BA1\u7406\u7CFB\u7D71");
		teamlabel2.setForeground(Color.WHITE);
		teamlabel2.setFont(new Font("微軟正黑體", Font.BOLD, 30));
		teamlabel2.setBounds(43, 72, 227, 60);
		sidebar.add(teamlabel2);
		...
		sidebarpic1.setIcon(new ImageIcon("C:\\Users\\user\\Desktop\\java_workspace\\find.png"));
		...
		sidebarpic2.setIcon(new ImageIcon("C:\\Users\\user\\Desktop\\java_workspace\\register.png"));
		...
		bgpanel.add(passwordfield);passwordfield.setColumns(20);
		
		JLabel welcome = new JLabel("");
		welcome.setIcon(new ImageIcon("C:\\Users\\user\\Desktop\\java_workspace\\login.png"));
		welcome.setFont(new Font("微軟正黑體", Font.BOLD, 60));
		welcome.setBounds(571, 60, 96, 91);
		bgpanel.add(welcome);
		...
		loginbutton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(ps.equals("1234")) System.out.println("yes");
		...
		loginbutton.setFont(new Font("微軟正黑體", Font.PLAIN, 40));
		loginbutton.setBounds(527, 326, 197, 57);
